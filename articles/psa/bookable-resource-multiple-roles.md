...
description: Este artigo fornece informações sobre como as dimensões de preços podem ser utilizadas para suportar preços e custeio para um recurso que preenche várias funções num projeto.
author: rumant
ms.custom:
