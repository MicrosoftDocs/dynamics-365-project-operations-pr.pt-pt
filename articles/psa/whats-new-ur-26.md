...
description: Este artigo lista as funcionalidades e correções disponíveis na Versão 26 da Atualização do Project Service Automation, V3.
author: ruhercul
...
Este artigo lista as funcionalidades e correções novas ou alteradas para a Versão 26 da Atualização do Project Service Automation, V3. Esta versão tem um número de compilação V3.10.44.59 e está geralmente disponível através de uma atualização automática em dezembro de 2020.
