...
description: Este artigo inclui informações sobre o que há de novo na Versão 13 da Atualização do Project Service Automation, V3.
author: ruhercul
...
Este artigo lista as funcionalidades e correções novas ou alteradas para a Versão 13 da Atualização do Project Service Automation V3. Esta versão tem um número de compilação de V3.10.3.18 e está disponível na seguinte agenda:
