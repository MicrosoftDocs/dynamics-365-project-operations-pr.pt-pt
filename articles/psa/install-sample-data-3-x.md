...
description: Este artigo fornece informações sobre a instalação de dados de amostra no Project Service Automation.
...
- **\<EntitiesToEnableScheduling\>** especifica as entidades que devem ser ativadas para Reserva no Microsoft Dynamics Scheduling (também conhecido como Universal Resource Scheduling).
