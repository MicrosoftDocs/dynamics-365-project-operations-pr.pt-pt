---
title: Detalhes do cabeçalho para contratos de projetos
description: Este artigo fornece informações sobre os campos e as informações sobre contratos do projeto no Project Operations.
author: rumant
ms.date: 03/08/2022
ms.topic: article
