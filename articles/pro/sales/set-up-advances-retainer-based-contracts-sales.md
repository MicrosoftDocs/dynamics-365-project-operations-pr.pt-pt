...
description: Este artigo fornece informações sobre modelos de contratação baseados em avenças e adiantamentos no Project Operations.
author: rumant
ms.date: 10/20/2020
ms.topic: article
