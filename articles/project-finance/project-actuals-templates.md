...
- Se estiver a criar um novo modelo, tem de adicionar a coluna para suportar o tempo e as despesas entre empresas. Selecione **Adicionar Coluna Condicional** e introduza um nome para a coluna, como **EntidadeJurídica**. Introduza uma condição para a coluna, em que, se **msdyn\_contractorganizationalunitid.msdyn\_name** for \<unidade organizacional\>, então \<introduzir a entidade jurídica\>; caso contrário, Null.
...
[![Mapeamento de modelos](./media/ActualsMapping.jpg)](./media/ActualsMapping.jpg)

[![Mapeamento de modelos](./media/TransactionConnections.jpg)](./media/TransactionConnections.jpg)
...
[![Mapeamento de modelos](./media/ActualsUpdateMapping.jpg)](./media/ActualsUpdateMapping.jpg)

[![Mapeamento de modelos](./media/TransactionConnectionsUpdate.jpg)](./media/TransactionConnectionsUpdate.jpg)
