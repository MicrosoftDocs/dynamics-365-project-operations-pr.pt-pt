---
title: Criar agendas de faturação num item de contrato em projetos
...
ms.locfileid: "9825112"
---
# <a name="create-invoice-schedules-on-a-project-based-contract-line"></a>Criar agendas de faturação num item de contrato em projetos
