---
title: Detalhes do cabeçalho para propostas baseadas em projetos
description: Este artigo fornece informações sobre as informações e definições que se aplicam e afetam propostas de projeto.
author: rumant
ms.date: 10/01/2020
ms.topic: article
