...
description: É possível configurar as políticas de despesas que os seus trabalhadores têm de seguir, introduzindo e submetendo relatórios de despesas e requisições de viagens no Microsoft Dynamics 365 Finance.
author: suvaidya
ms.date: 05/20/2020
ms.topic: article
ms.prod: ''
