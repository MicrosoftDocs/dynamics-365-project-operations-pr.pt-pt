...
description: Este tópico explica como pode usar o sistema de fluxos de trabalho no Microsoft Dynamics 365 Finance, para configurar um processo de revisão para relatórios de despesas na gestão de Despesas.
