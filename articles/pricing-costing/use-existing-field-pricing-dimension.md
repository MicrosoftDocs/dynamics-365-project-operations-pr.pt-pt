---
title: Campos do Project Operations como dimensões de preços
description: Este artigo fornece informações sobre a utilização de campos como dimensões de preços no Dynamics 365 Project Operations.
author: rumant
ms.date: 09/18/2020
ms.topic: article
ms.prod: ''
