...
## <a name="using-journals-to-record-costs"></a>Utilizar diários para registar custos

Em PSA, os diários permitem-lhe registar o custo ou a receita nas classes de material, taxa, hora, despesa ou imposto. Um diário tem um cabeçalho, linhas e uma ação de **Confirmação**. Seguem-se alguns cenários em que poderá utilizar um diário:
...
<tbody>
<tr>
<td>É criada uma entrada de tempo.</td>
<td colspan="6">Sem atividade na entidade Valores Reais</td>
</tr>
<tr>
<td>É submetida uma entrada de tempo.</td>
<td colspan="6">Sem atividade na entidade Valores Reais</td>
</tr>
<tr>
