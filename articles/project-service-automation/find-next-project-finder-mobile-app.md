...
## <a name="find-a-project"></a>Localizar um projeto  
 ...
 ![Lista de projetos que correspondem às competências na aplicação Project Finder Mobile](../project-service/media/project-service-project-finder-list.png "Lista de projetos que correspondem às competências na aplicação Project Finder Mobile")  
...
## <a name="update-your-skills"></a>Atualizar as competências  
 ...
 ![Botão Perfil na aplicação Project Finder Mobile](../project-service/media/project-service-project-finder-profile.png "Botão Perfil na aplicação Project Finder Mobile")  
