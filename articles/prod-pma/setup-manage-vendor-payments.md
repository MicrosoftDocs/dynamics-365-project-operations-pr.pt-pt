...
description: Este artigo explica como criar termos PWP (pay-when-paid) para que possa libertar pagamentos parciais de fornecedores, com base em pagamentos de clientes.
author: RadhikaRS
ms.date: 03/30/2020
ms.topic: article
ms.prod: ''
