...
Este artigo descreve os modelos e tarefas subjacentes que são utilizados para sincronizar valores reais do projeto diretamente do Dynamics 365 Project Service Automation para o Dynamics 365 Finance.
