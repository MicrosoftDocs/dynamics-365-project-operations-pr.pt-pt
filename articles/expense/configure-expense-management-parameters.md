...
description: Este artigo descreve os parâmetros que controlam o comportamento geral na Gestão de despesas.
author: suvaidya
ms.date: 10/01/2020
ms.topic: article
...
ms.locfileid: "8931482"
---
# <a name="configure-expense-management-parameters"></a>Configurar parâmetros de gestão de despesas

_**Aplica-se A:** Project Operations para cenários baseados em recursos/não armazenados_

Este artigo descreve os parâmetros que controlam o comportamento geral na Gestão de despesas.
