...
description: Este artigo fornece informações sobre como funciona a reserva de métodos de alocação no Project Operations.
author: ruhercul
ms.date: 09/23/2020
ms.topic: article
ms.prod: ''
